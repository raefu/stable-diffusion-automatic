...
options_templates.update(options_section(('upscaling', "Upscaling"), {
    ...
    "realesrgan_enabled_models": OptionInfo(["Real-ESRGAN 2x plus", "Real-ESRGAN 4x plus", "Real-ESRGAN 4x plus anime 6B"], "Select which RealESRGAN models to show in the web UI. (Requires restart)", gr.CheckboxGroup, lambda: {"choices": realesrgan_models_names()}),
...
options_templates.update(options_section(('sd', "Stable Diffusion"), {
    ...
    "use_old_emphasis_implementation": OptionInfo(True, "Use old emphasis implementation. Can be useful to reproduce old seeds."),
