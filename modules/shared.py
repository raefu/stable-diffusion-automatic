...
options_templates.update(options_section(('upscaling', "Upscaling"), {
    ...
    "realesrgan_enabled_models": OptionInfo(["R-ESRGAN 2x+", "R-ESRGAN x4+", "R-ESRGAN x4+ Anime6B"], "Select which Real-ESRGAN models to show in the web UI. (Requires restart)", gr.CheckboxGroup, lambda: {"choices": realesrgan_models_names()}),
